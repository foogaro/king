...
echo "Added the OData role to the King user!"
/opt/eap/bin/add-user.sh -a --silent=true -u "luigi" -p "luigi.2017" -g "admin,connect,odata"
echo "Added the OData role to the Luigi user!"
